        ...
        <section className="space-y-6">
          <div className="rounded-[32px] border border-[#FFB3DF] bg-white p-10 shadow-card">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-semibold text-[#111827]">Manage inbound enquiries</h1>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-slate-200 text-left text-sm">
                <thead className="border-b border-[#FFB3DF]">
                  <tr>
                    <th className="px-4 py-4 text-[#6B7280]">Name</th>
                    <th className="px-4 py-4 text-[#6B7280]">Email</th>
                    <th className="px-4 py-4 text-[#6B7280]">Enquiry</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200">
                  {sampleLeads.map((lead) => (
                    <tr key={lead.id}>
                      <td className="px-4 py-4 font-medium text-[#111827]">{lead.name}</td>
                      <td className="px-4 py-4 text-[#6B7280]">{lead.email}</td>
                      <td className="px-4 py-4 text-[#6B7280]">{lead.enquiry}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
